...
const works = [
  ...
  {
    link: "https://dev-app.taccuinu.com",
    name: "Taccuinu",
    projectOverview: {
      name: "Project Overview:",
      desc: [
        "This web application empowers traders to track their activity and analyze performance effectively. Built with React, Tailwind CSS, TypeScript, and TradingView integration, it offers a comprehensive suite of features:",
